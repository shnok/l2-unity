	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			Option:Workflow:Specular,Metallic,BlinnPhong,Lambert:Metallic
				...
				Lambert:HidePort:Forward:Metallic
				Lambert:ShowPort:Forward:Specular
				Lambert:SetPropertyOnSubShader:ChangeTagValue,UniversalMaterialType,SimpleLit
			...
			Option:Receive Shadows:false,true:true
				false,disable:SetDefine:_RECEIVE_SHADOWS_OFF 1
			...
			Option:Clear Coat:false,true:false
				...
				true:SetDefine:Forward:pragma shader_feature_local_fragment _ _CLEARCOAT
