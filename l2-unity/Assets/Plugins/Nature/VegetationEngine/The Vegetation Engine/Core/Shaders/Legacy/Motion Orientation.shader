// Upgrade NOTE: upgraded instancing buffer 'HiddenBOXOPHOBICTheVegetationEngineElementsMotionOrientation' to new syntax.

// Made with Amplify Shader Editor v1.9.2.2
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hidden/BOXOPHOBIC/The Vegetation Engine/Elements/Motion Orientation"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(HiddenBOXOPHOBICTheVegetationEngineElementsMotionOrientation)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr HiddenBOXOPHOBICTheVegetationEngineElementsMotionOrientation
			UNITY_INSTANCING_BUFFER_END(HiddenBOXOPHOBICTheVegetationEngineElementsMotionOrientation)
			...
			v2f vert ( appdata v )
			{
				...
				float2 appendResult1900_g20879 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 lerpResult1899_g20879 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g20879 , _ElementUVsMode);
				float2 vertexToFrag11_g22152 = ( ( lerpResult1899_g20879 * (_MainUVs).xy ) + (_MainUVs).zw );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g20879 = tex2D( _MainTex, vertexToFrag11_g22152 );
				float3 temp_cast_2 = (0.0001).xxx;
				float3 temp_cast_3 = (0.9999).xxx;
				float3 clampResult17_g22182 = clamp( (MainTex_RGBA587_g20879).rgb , temp_cast_2 , temp_cast_3 );
				...
				float3 temp_output_1765_0_g20879 = saturate( ( ( clampResult17_g22182 - temp_cast_4 ) / temp_output_10_0_g22183 ) );
				...
				float2 appendResult1382_g20879 = (float2(i.ase_texcoord2.z , i.ase_texcoord3.x));
				half2 Direction_Velocity1394_g20879 = ( appendResult1382_g20879 / i.ase_texcoord3.y );
				...
				half2 Noise_Coords1409_g20879 = ( -( (( WorldPosition - TVE_WorldOrigin )).xz * 0.1 ) * Noise_Scale892_g20879 );
				...
				half Noise_Phase1970_g20879 = _NoisePhaseValue;
				float temp_output_15_0_g21053 = (lerpResult128_g21052*Noise_Speed898_g20879 + Noise_Phase1970_g20879);
				...
				float clampResult17_g22148 = clamp( (MainTex_RGBA587_g20879).a , 0.0001 , 0.9999 );
				...
				half Element_Remap_A74_g20879 = saturate( ( ( clampResult17_g22148 - temp_output_7_0_g22149 ) / ( temp_output_10_0_g22149 + 0.0001 ) ) );
				...
				half Element_Fallof1883_g20879 = saturate( ( ( clampResult17_g21978 - temp_output_7_0_g21979 ) / ( temp_output_10_0_g21979 + 0.0001 ) ) );
				...
				half Element_Alpha56_g20879 = ( _ElementIntensity * Element_Remap_A74_g20879 * Element_Params_A1737_g20879 * i.ase_color.a * Element_Fallof1883_g20879 * lerpResult842_g20879 );
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.FunctionNode;117;-640,-1280;Inherit;False;Define Element Motion;77;;19417;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-640,-1152;Half;False;Property;_render_colormask;_render_colormask;79;1;[HideInInspector];Create;True;0;0;0;True;0;False;15;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-304,-1024;Float;False;True;-1;2;TVEShaderElementGUI;0;5;Hidden/BOXOPHOBIC/The Vegetation Engine/Elements/Motion Orientation;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;4;1;False;;1;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;True;True;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
Node;AmplifyShaderEditor.FunctionNode;166;-638,-1024;Inherit;False;Base Element;2;;20879;0e972c73cae2ee54ea51acc9738801d0;12,477,2,1778,2,478,0,1824,0,145,3,1814,3,1784,2,481,2,1935,1,1933,1,1904,1,1907,1;0;2;FLOAT4;0;FLOAT4;1779
WireConnection;0;0;166;0
ASEEND*/
//CHKSM=690D0B824BD07511EAAC43EBCCBB154485632F02