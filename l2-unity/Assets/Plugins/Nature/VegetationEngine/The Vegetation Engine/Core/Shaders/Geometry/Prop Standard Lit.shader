		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g76401 = v.positionOS.xyz;
				float3 Final_VertexPosition890_g76401 = ( VertexPosition3588_g76401 + _DisableSRPBatcher );
				...
				float2 Mesh_DetailCoord3_g76401 = appendResult21_g76576;
				float2 temp_output_29_0_g76581 = ( Mesh_DetailCoord3_g76401 * break33_g76581.y );
				...
				float2 temp_output_31_0_g76581 = ( (WorldPosition_Shifted7477_g76401).xz * break33_g76581.z );
				half2 Second_UVs_Tilling7609_g76401 = (_SecondUVs).xy;
				half2 Second_UVs_Scale7610_g76401 = ( 1.0 / Second_UVs_Tilling7609_g76401 );
				float2 lerpResult7614_g76401 = lerp( Second_UVs_Tilling7609_g76401 , Second_UVs_Scale7610_g76401 , _SecondUVsScaleMode);
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord9.xy = vertexToFrag11_g76427;
				o.ase_texcoord10.xyz = vertexToFrag3890_g76401;
				float4x4 break19_g76457 = GetObjectToWorldMatrix();
				float3 appendResult20_g76457 = (float3(break19_g76457[ 0 ][ 3 ] , break19_g76457[ 1 ][ 3 ] , break19_g76457[ 2 ][ 3 ]));
				...
				float3 temp_output_122_0_g76457 = Mesh_PivotsData2831_g76401;
				float3 PivotsOnly105_g76457 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g76457 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g76459 = ( appendResult20_g76457 + PivotsOnly105_g76457 );
				half3 WorldData19_g76459 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g76459 = WorldData19_g76459;
				#else
				float3 staticSwitch14_g76459 = ObjectData20_g76459;
				#endif
				float3 temp_output_114_0_g76457 = staticSwitch14_g76459;
				float3 vertexToFrag4224_g76401 = temp_output_114_0_g76457;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float clampResult17_g76560 = clamp( Main_Mask57_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76561 = _MainMaskMinValue;
				float temp_output_10_0_g76561 = ( _MainMaskMaxValue - temp_output_7_0_g76561 );
				half Main_Mask_Remap5765_g76401 = saturate( ( ( clampResult17_g76560 - temp_output_7_0_g76561 ) / ( temp_output_10_0_g76561 + 0.0001 ) ) );
				float lerpResult7671_g76401 = lerp( 1.0 , Main_Mask_Remap5765_g76401 , _MainColorMode);
				float4 lerpResult7654_g76401 = lerp( _MainColorTwo , _MainColor , lerpResult7671_g76401);
				half3 Main_Color_RGB7657_g76401 = (lerpResult7654_g76401).rgb;
				half3 Main_Albedo99_g76401 = ( lerpResult6223_g76401 * Main_Color_RGB7657_g76401 );
				float2 vertexToFrag11_g76427 = IN.ase_texcoord9.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				...
				float clampResult17_g76563 = clamp( Second_Mask81_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76564 = _SecondMaskMinValue;
				float temp_output_10_0_g76564 = ( _SecondMaskMaxValue - temp_output_7_0_g76564 );
				half Second_Mask_Remap6130_g76401 = saturate( ( ( clampResult17_g76563 - temp_output_7_0_g76564 ) / ( temp_output_10_0_g76564 + 0.0001 ) ) );
				float lerpResult7672_g76401 = lerp( 1.0 , Second_Mask_Remap6130_g76401 , _SecondColorMode);
				float4 lerpResult7662_g76401 = lerp( _SecondColorTwo , _SecondColor , lerpResult7672_g76401);
				half3 Second_Color_RGB7663_g76401 = (lerpResult7662_g76401).rgb;
				half3 Second_Albedo153_g76401 = ( lerpResult6225_g76401 * Second_Color_RGB7663_g76401 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g76443 = 2.0;
				#else
				float staticSwitch1_g76443 = 4.594794;
				#endif
				float3 lerpResult4834_g76401 = lerp( ( Main_Albedo99_g76401 * Second_Albedo153_g76401 * staticSwitch1_g76443 ) , Second_Albedo153_g76401 , _DetailBlendMode);
				float lerpResult6885_g76401 = lerp( Main_Mask57_g76401 , Second_Mask81_g76401 , _DetailMaskMode);
				float clampResult17_g76483 = clamp( lerpResult6885_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76482 = _DetailMaskMinValue;
				float temp_output_10_0_g76482 = ( _DetailMaskMaxValue - temp_output_7_0_g76482 );
				half Blend_Mask_Texture6794_g76401 = saturate( ( ( clampResult17_g76483 - temp_output_7_0_g76482 ) / ( temp_output_10_0_g76482 + 0.0001 ) ) );
				half Mesh_DetailMask90_g76401 = IN.ase_color.b;
				half4 Normal_Packed45_g76559 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g76401 );
				...
				#endif
				float2 temp_output_6555_0_g76401 = ( (staticSwitch37_g76559*2.0 + -1.0) * _MainNormalValue );
				...
				float clampResult17_g76481 = clamp( lerpResult6884_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76480 = _DetailMeshMinValue;
				float temp_output_10_0_g76480 = ( _DetailMeshMaxValue - temp_output_7_0_g76480 );
				half Blend_Mask_Mesh1540_g76401 = saturate( ( ( clampResult17_g76481 - temp_output_7_0_g76480 ) / ( temp_output_10_0_g76480 + 0.0001 ) ) );
				float clampResult17_g76504 = clamp( ( Blend_Mask_Texture6794_g76401 * Blend_Mask_Mesh1540_g76401 ) , 0.0001 , 0.9999 );
				...
				half Blend_Mask147_g76401 = ( saturate( ( ( clampResult17_g76504 - temp_output_7_0_g76552 ) / ( temp_output_10_0_g76552 + 0.0001 ) ) ) * _DetailMode * _DetailValue );
				...
				float clampResult17_g76449 = clamp( Mesh_Occlusion318_g76401 , 0.0001 , 0.9999 );
				float temp_output_7_0_g76455 = _VertexOcclusionMinValue;
				float temp_output_10_0_g76455 = ( _VertexOcclusionMaxValue - temp_output_7_0_g76455 );
				half Occlusion_Mask6432_g76401 = saturate( ( ( clampResult17_g76449 - temp_output_7_0_g76455 ) / ( temp_output_10_0_g76455 + 0.0001 ) ) );
				...
				float3 temp_output_3_0_g76447 = Blend_Albedo_Tinted2808_g76401;
				float dotResult20_g76447 = dot( temp_output_3_0_g76447 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g76401 = dotResult20_g76447;
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g76401).xxx;
				float temp_output_82_0_g76422 = _LayerColorsValue;
				float temp_output_19_0_g76426 = TVE_ColorsUsage[(int)temp_output_82_0_g76422];
				float4 temp_output_91_19_g76422 = TVE_ColorsCoords;
				...
				float3 lerpResult4822_g76401 = lerp( WorldPosition3905_g76401 , ObjectPosition4223_g76401 , _ColorsPositionMode);
				half2 UV94_g76422 = ( (temp_output_91_19_g76422).zw + ( (temp_output_91_19_g76422).xy * (lerpResult4822_g76401).xz ) );
				float4 tex2DArrayNode83_g76422 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76422,temp_output_82_0_g76422, 0.0 );
				float4 temp_output_17_0_g76426 = tex2DArrayNode83_g76422;
				float4 temp_output_92_86_g76422 = TVE_ColorsParams;
				float4 temp_output_3_0_g76426 = temp_output_92_86_g76422;
				float4 ifLocalVar18_g76426 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g76426 >= 0.5 )
				ifLocalVar18_g76426 = temp_output_17_0_g76426;
				else
				ifLocalVar18_g76426 = temp_output_3_0_g76426;
				float4 lerpResult22_g76426 = lerp( temp_output_3_0_g76426 , temp_output_17_0_g76426 , temp_output_19_0_g76426);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g76426 = lerpResult22_g76426;
				#else
				float4 staticSwitch24_g76426 = ifLocalVar18_g76426;
				#endif
				half4 Global_Colors_Params5434_g76401 = staticSwitch24_g76426;
				float4 temp_output_346_0_g76408 = Global_Colors_Params5434_g76401;
				half Global_Colors_A1701_g76401 = saturate( (temp_output_346_0_g76408).w );
				half Colors_Influence3668_g76401 = Global_Colors_A1701_g76401;
				float temp_output_6306_0_g76401 = ( 1.0 - Colors_Influence3668_g76401 );
				float3 lerpResult3618_g76401 = lerp( Blend_Albedo_Tinted2808_g76401 , temp_cast_1 , ( 1.0 - ( temp_output_6306_0_g76401 * temp_output_6306_0_g76401 ) ));
				half3 Global_Colors_RGB1700_g76401 = (temp_output_346_0_g76408).xyz;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g76439 = 2.0;
				#else
				float staticSwitch1_g76439 = 4.594794;
				#endif
				half3 Colors_RGB1954_g76401 = ( Global_Colors_RGB1700_g76401 * staticSwitch1_g76439 * _ColorsIntensityValue );
				float lerpResult6617_g76401 = lerp( Main_Mask_Remap5765_g76401 , Second_Mask_Remap6130_g76401 , Blend_Mask147_g76401);
				#ifdef TVE_DETAIL
				float staticSwitch6623_g76401 = lerpResult6617_g76401;
				#else
				float staticSwitch6623_g76401 = Main_Mask_Remap5765_g76401;
				#endif
				half Blend_Mask_Remap6621_g76401 = staticSwitch6623_g76401;
				float lerpResult7679_g76401 = lerp( 1.0 , Blend_Mask_Remap6621_g76401 , _ColorsMaskValue);
				half Colors_Value3692_g76401 = ( lerpResult7679_g76401 * _GlobalColors );
				half Colors_Variation3650_g76401 = 1.0;
				half Occlusion_Alpha6463_g76401 = _VertexOcclusionColor.a;
				float lerpResult6459_g76401 = lerp( Occlusion_Mask6432_g76401 , ( 1.0 - Occlusion_Mask6432_g76401 ) , _VertexOcclusionColorsMode);
				float lerpResult6461_g76401 = lerp( Occlusion_Alpha6463_g76401 , 1.0 , lerpResult6459_g76401);
				half Occlusion_Colors6450_g76401 = lerpResult6461_g76401;
				float3 temp_output_3_0_g76448 = ( Blend_Albedo265_g76401 * Tint_Gradient_Color5769_g76401 * Tint_Noise_Color5770_g76401 );
				float dotResult20_g76448 = dot( temp_output_3_0_g76448 , float3(0.2126,0.7152,0.0722) );
				float clampResult6740_g76401 = clamp( saturate( ( dotResult20_g76448 * 5.0 ) ) , 0.2 , 1.0 );
				...
				float lerpResult16_g76440 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g76401 * Colors_Influence3668_g76401 * Colors_Variation3650_g76401 * Occlusion_Colors6450_g76401 * Blend_Albedo_Globals6410_g76401 ) - temp_output_7_0_g76489 ) / ( temp_output_10_0_g76489 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult3628_g76401 = lerp( Blend_Albedo_Tinted2808_g76401 , ( lerpResult3618_g76401 * Colors_RGB1954_g76401 ) , lerpResult16_g76440);
				half3 Blend_Albedo_Colored_High6027_g76401 = lerpResult3628_g76401;
				half3 Blend_Albedo_Colored863_g76401 = Blend_Albedo_Colored_High6027_g76401;
				half3 Global_OverlayColor1758_g76401 = (TVE_OverlayColor).rgb;
				float temp_output_84_0_g76417 = _LayerExtrasValue;
				float temp_output_19_0_g76421 = TVE_ExtrasUsage[(int)temp_output_84_0_g76417];
				float4 temp_output_93_19_g76417 = TVE_ExtrasCoords;
				float3 lerpResult4827_g76401 = lerp( WorldPosition3905_g76401 , ObjectPosition4223_g76401 , _ExtrasPositionMode);
				half2 UV96_g76417 = ( (temp_output_93_19_g76417).zw + ( (temp_output_93_19_g76417).xy * (lerpResult4827_g76401).xz ) );
				float4 tex2DArrayNode48_g76417 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g76417,temp_output_84_0_g76417, 0.0 );
				float4 temp_output_17_0_g76421 = tex2DArrayNode48_g76417;
				float4 temp_output_94_85_g76417 = TVE_ExtrasParams;
				float4 temp_output_3_0_g76421 = temp_output_94_85_g76417;
				float4 ifLocalVar18_g76421 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g76421 >= 0.5 )
				ifLocalVar18_g76421 = temp_output_17_0_g76421;
				else
				ifLocalVar18_g76421 = temp_output_3_0_g76421;
				float4 lerpResult22_g76421 = lerp( temp_output_3_0_g76421 , temp_output_17_0_g76421 , temp_output_19_0_g76421);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g76421 = lerpResult22_g76421;
				#else
				float4 staticSwitch24_g76421 = ifLocalVar18_g76421;
				#endif
				half4 Global_Extras_Params5440_g76401 = staticSwitch24_g76421;
				float4 break456_g76431 = Global_Extras_Params5440_g76401;
				half Global_Extras_Overlay156_g76401 = break456_g76431.z;
				...
				half4 Normal_Packed45_g76562 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
				...
				#endif
				float2 temp_output_6560_0_g76401 = ( (staticSwitch37_g76562*2.0 + -1.0) * _SecondNormalValue );
				half2 Normal_Planar45_g76565 = temp_output_6560_0_g76401;
				float2 break64_g76565 = Normal_Planar45_g76565;
				float3 appendResult65_g76565 = (float3(break64_g76565.x , 0.0 , break64_g76565.y));
				float2 temp_output_7603_0_g76401 = (mul( ase_worldToTangent, appendResult65_g76565 )).xy;
				float2 ifLocalVar7604_g76401 = 0;
				if( _SecondUVsMode >= 2.0 )
				ifLocalVar7604_g76401 = temp_output_7603_0_g76401;
				else
				ifLocalVar7604_g76401 = temp_output_6560_0_g76401;
				half2 Second_Normal179_g76401 = ifLocalVar7604_g76401;
				float2 temp_output_36_0_g76444 = ( lerpResult3372_g76401 + Second_Normal179_g76401 );
				float2 lerpResult3376_g76401 = lerp( Main_Normal137_g76401 , temp_output_36_0_g76444 , Blend_Mask147_g76401);
				#ifdef TVE_DETAIL
				...
				float lerpResult7693_g76401 = lerp( Occlusion_Mask6432_g76401 , ( 1.0 - Occlusion_Mask6432_g76401 ) , _VertexOcclusionOverlayMode);
				float lerpResult6467_g76401 = lerp( Occlusion_Alpha6463_g76401 , 1.0 , lerpResult7693_g76401);
				half Occlusion_Overlay6471_g76401 = lerpResult6467_g76401;
				float temp_output_7_0_g76453 = 0.1;
				float temp_output_10_0_g76453 = ( 0.2 - temp_output_7_0_g76453 );
				half Overlay_Mask_High6064_g76401 = saturate( ( ( ( Overlay_Value5738_g76401 * Overlay_Projection6081_g76401 * Overlay_Shading6688_g76401 * Overlay_Custom6707_g76401 * Occlusion_Overlay6471_g76401 ) - temp_output_7_0_g76453 ) / ( temp_output_10_0_g76453 + 0.0001 ) ) );
				...
				half Global_Extras_Wetness305_g76401 = break456_g76431.y;
				...
				float3 temp_output_13_0_g76432 = appendResult6568_g76401;
				float3 temp_output_33_0_g76432 = ( temp_output_13_0_g76432 * _render_normals );
				float3 switchResult12_g76432 = (((ase_vface>0)?(temp_output_13_0_g76432):(temp_output_33_0_g76432)));
				
				float3 temp_cast_11 = (0.0).xxx;
				float3 temp_output_7161_0_g76401 = (_EmissiveColor).rgb;
				half3 Emissive_Color7162_g76401 = temp_output_7161_0_g76401;
				...
				half3 Emissive_Texture7022_g76401 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g76401 )).rgb - temp_cast_12 ) / ( temp_output_10_0_g76582 + 0.0001 ) ) );
				half Global_Extras_Emissive4203_g76401 = break456_g76431.x;
				...
				float3 temp_output_3_0_g76584 = ( Emissive_Color7162_g76401 * Emissive_Mask6968_g76401 );
				...
				#ifdef TVE_EMISSIVE
				float3 staticSwitch7687_g76401 = temp_output_23_0_g76584;
				#else
				float3 staticSwitch7687_g76401 = temp_cast_11;
				#endif
				half3 Final_Emissive2476_g76401 = staticSwitch7687_g76401;
				
				half Main_Metallic237_g76401 = ( tex2DNode35_g76401.r * _MainMetallicValue );
				half Second_Metallic226_g76401 = ( tex2DNode33_g76401.r * _SecondMetallicValue );
				float lerpResult278_g76401 = lerp( Main_Metallic237_g76401 , Second_Metallic226_g76401 , Blend_Mask147_g76401);
				#ifdef TVE_DETAIL
				float staticSwitch299_g76401 = lerpResult278_g76401;
				#else
				float staticSwitch299_g76401 = Main_Metallic237_g76401;
				#endif
				half Blend_Metallic306_g76401 = staticSwitch299_g76401;
				float lerpResult342_g76401 = lerp( Blend_Metallic306_g76401 , 0.0 , Overlay_Mask269_g76401);
				half Blend_Metallic_Overlay367_g76401 = lerpResult342_g76401;
				...
				float temp_output_7_0_g76454 = TVE_CameraFadeMin;
				float temp_output_10_0_g76454 = ( TVE_CameraFadeMax - temp_output_7_0_g76454 );
				float lerpResult4755_g76401 = lerp( 1.0 , saturate( saturate( ( ( distance( WorldPosition , _WorldSpaceCameraPos ) - temp_output_7_0_g76454 ) / ( temp_output_10_0_g76454 + 0.0001 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g76401 = lerpResult4755_g76401;
				half Fade_Effects_B6228_g76401 = ( Fade_Effects_A5360_g76401 * Fade_Camera3743_g76401 );
				...
				float lerpResult5141_g76401 = lerp( 1.0 , ( Fade_Effects_B6228_g76401 * ( 1.0 - _FadeConstantValue ) ) , Fade_Mask5149_g76401);
				half Fade_Effects_C7653_g76401 = lerpResult5141_g76401;
				float temp_output_5865_0_g76401 = saturate( ( Fade_Effects_C7653_g76401 - SAMPLE_TEXTURE3D( TVE_NoiseTex3D, sampler_Linear_Repeat, ( TVE_NoiseTex3DTilling * WorldPosition3905_g76401 ) ).r ) );
				half Fade_Alpha3727_g76401 = temp_output_5865_0_g76401;
				half Final_Alpha7344_g76401 = min( ( ( Blend_Alpha6157_g76401 - AlphaTreshold2132_g76401 ) * Global_Alpha315_g76401 ) , Fade_Alpha3727_g76401 );
				float temp_output_3_0_g76558 = Final_Alpha7344_g76401;
				...
				half Main_Color_Alpha6121_g76401 = (lerpResult7654_g76401).a;
				half Second_Color_Alpha6152_g76401 = (lerpResult7662_g76401).a;
				...
				half Final_Clip914_g76401 = saturate( ( Alpha19_g76558 * Blend_Color_Alpha6167_g76401 ) );
				

				float3 BaseColor = Blend_Albedo_RimLight7316_g76401;
				float3 Normal = switchResult12_g76432;
				float3 Emission = Final_Emissive2476_g76401;
				float3 Specular = 0.5;
				float Metallic = Blend_Metallic_Overlay367_g76401;
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord4.xy = vertexToFrag11_g76427;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76401 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76401 );
				half Main_Alpha316_g76401 = tex2DNode29_g76401.a;
				float2 vertexToFrag11_g76427 = IN.ase_texcoord4.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				half Second_Alpha5007_g76401 = tex2DNode89_g76401.a;
				float4 tex2DNode35_g76401 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76401 );
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord5.xy = vertexToFrag11_g76427;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76401 = (lerpResult7654_g76401).rgb;
				half3 Main_Albedo99_g76401 = ( lerpResult6223_g76401 * Main_Color_RGB7657_g76401 );
				float2 vertexToFrag11_g76427 = IN.ase_texcoord5.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				float3 lerpResult6225_g76401 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76401).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76401 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord3.xy = vertexToFrag11_g76427;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Main_Color_RGB7657_g76401 = (lerpResult7654_g76401).rgb;
				half3 Main_Albedo99_g76401 = ( lerpResult6223_g76401 * Main_Color_RGB7657_g76401 );
				float2 vertexToFrag11_g76427 = IN.ase_texcoord3.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				float3 lerpResult6225_g76401 = lerp( float3( 1,1,1 ) , (tex2DNode89_g76401).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g76401 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord7.xy = vertexToFrag11_g76427;
				o.ase_texcoord8.xyz = vertexToFrag3890_g76401;
				float4x4 break19_g76457 = GetObjectToWorldMatrix();
				float3 appendResult20_g76457 = (float3(break19_g76457[ 0 ][ 3 ] , break19_g76457[ 1 ][ 3 ] , break19_g76457[ 2 ][ 3 ]));
				float3 appendResult60_g76411 = (float3(v.ase_texcoord3.x , v.ase_texcoord3.z , v.ase_texcoord3.y));
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float2 vertexToFrag11_g76427 = IN.ase_texcoord7.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				half4 Normal_Packed45_g76562 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g76401 );
				float2 appendResult58_g76562 = (float2(( (Normal_Packed45_g76562).x * (Normal_Packed45_g76562).w ) , (Normal_Packed45_g76562).y));
				half2 Normal_Default50_g76562 = appendResult58_g76562;
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				half2 Second_UVs_Offset7605_g76401 = (_SecondUVs).zw;
				float2 vertexToFrag11_g76427 = ( ( ( temp_output_30_0_g76581 + temp_output_29_0_g76581 + temp_output_31_0_g76581 ) * lerpResult7614_g76401 ) + Second_UVs_Offset7605_g76401 );
				o.ase_texcoord1.xy = vertexToFrag11_g76427;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g76401 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g76401 );
				half Main_Alpha316_g76401 = tex2DNode29_g76401.a;
				float2 vertexToFrag11_g76427 = IN.ase_texcoord1.xy;
				half2 Second_UVs17_g76401 = vertexToFrag11_g76427;
				float4 tex2DNode89_g76401 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g76401 );
				half Second_Alpha5007_g76401 = tex2DNode89_g76401.a;
				float4 tex2DNode35_g76401 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g76401 );
				...
				float temp_output_7_0_g76454 = TVE_CameraFadeMin;
				float temp_output_10_0_g76454 = ( TVE_CameraFadeMax - temp_output_7_0_g76454 );
				float lerpResult4755_g76401 = lerp( 1.0 , saturate( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g76454 ) / ( temp_output_10_0_g76454 + 0.0001 ) ) ) ) , _FadeCameraValue);
				half Fade_Camera3743_g76401 = lerpResult4755_g76401;
				half Fade_Effects_B6228_g76401 = ( Fade_Effects_A5360_g76401 * Fade_Camera3743_g76401 );
				float lerpResult6866_g76401 = lerp( ( 1.0 - Blend_Mask147_g76401 ) , 1.0 , _DetailFadeMode);
				#ifdef TVE_DETAIL
...
Node;AmplifyShaderEditor.RangedFloatNode;404;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;252;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=686025871B3AC6399DCA086D98375D305948F7AB
