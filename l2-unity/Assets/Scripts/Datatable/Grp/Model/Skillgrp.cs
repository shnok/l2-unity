...
public class Skillgrp
{
    ...
    [SerializeField] private SkillMagicType _is_magic;  // 1 = buff/damage, 3 = songs/dances, 4 = resurrection, 6 = dimensional skills, 
    ...
    public SkillMagicType IsMagic { get => _is_magic; set => _is_magic = value; }
