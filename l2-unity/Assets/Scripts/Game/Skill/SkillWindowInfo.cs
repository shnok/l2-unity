public class SkillWindowInfo
{
    ...
    public string GetSkillType() =>
        Type switch
        {
            ...
            _ when Type == SkillType.Damage || Type == SkillType.Toggle && IsMagic == IsMagicType.None => "Active Skill",
            _ when Type == SkillType.Damage || Type == SkillType.HealsCubicsRaidsDebuff && IsMagic != IsMagicType.None => "Magic",
            _ when Type == SkillType.Buff && IsMagic == IsMagicType.DamageBuffHeal => "Synergy/Song/Dance",
            _ => string.Empty
        };
