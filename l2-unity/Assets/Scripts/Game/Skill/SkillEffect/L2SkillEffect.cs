...
public class L2SkillEffect
{
    ...
    [SerializeField] private List<EffectEmitter> _explosionActions;
    ...
    public List<EffectEmitter> ExplosionActions { get { return _explosionActions; } set { _explosionActions = value; } }
}
